...
?>
  ...
  <h4 style="margin-top:30px;"><a href="/9_board/">HOME</a></h4>
    <table class="list-table">
      ...
      <tbody>
        ...
        <?php
          ...
          ?>
        <a href='/9_board/page/board/<?php echo $boardurl; ?>.php?idx=<?php echo $board["idx"]; ?>'><span style="background:yellow;"><?php echo $title; ?></span><span class="re_ct">[<?php echo $rep_count;?>]<?php echo $img; ?> </span></a></td>
